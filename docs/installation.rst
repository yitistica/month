...
To install month package, run this command in your terminal:

.. code-block:: console

    $ pip install month

This is the preferred method to install month package, as it will always install the most recent stable release.
